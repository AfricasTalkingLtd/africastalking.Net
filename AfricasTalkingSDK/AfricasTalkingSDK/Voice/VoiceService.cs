    ...
    public class VoiceService : Service
    {
        ...
        public CallResponse Call(string phoneNumber)
        {
            try 
            {
                ...
                var callResponse = JsonConvert.DeserializeObject<CallResponse>(response);
                return callResponse;
            } 
            catch (Exception e)
            {
        ...
        public QueuedCallsResponse FetchQueuedCalls(string phoneNumber)
        {
            try
            {
                ...
                var queuedCallsResponse = JsonConvert.DeserializeObject<QueuedCallsResponse>(response);
