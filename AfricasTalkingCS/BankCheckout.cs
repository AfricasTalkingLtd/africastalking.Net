...
namespace AfricasTalkingCS
{
    ...
    public partial class BankCheckout
    {
        ...
        ///     This is a complex type whose structure is described below. It contains the details of the bank account to be
        ///     charged in this transaction.
        /// </summary>
    ...
    public partial class BankCheckout
    {
        ...
        /// </returns>
        public static BankCheckout BankChecoutFromJson(string json)
        {
            return JsonConvert.DeserializeObject<BankCheckout>(json, BankCheckoutConverter.Settings);
        }
    }
}