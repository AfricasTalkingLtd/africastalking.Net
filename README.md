<p align="center">
  <img height="100" src="https://avatars2.githubusercontent.com/u/12639968" 
			 alt="Africa's Talking logo" title="Africa's Talking logo">
</p>
...
[![Build status](https://ci.appveyor.com/api/projects/status/f5h48x3nk98oslo3?svg=true)](https://ci.appveyor.com/project/tmacharia/africastalking-net)

[![NuGet](https://img.shields.io/nuget/v/AfricasTalking.NET.svg?logo=nuget)](https://www.nuget.org/packages/AfricasTalking.NET/)
![SDK Downloads on Nuget](https://img.shields.io/nuget/dt/AfricasTalking.NET.svg?label=downloads&logo=nuget&link=https://www.nuget.org/packages/AfricasTalking.NET//left)
...
```powershell 
 dotnet add package AfricasTalking.NET --version 1.1.720
```
...
```powershell 
Install-Package AfricasTalking.NET -Version 1.1.720 
```
> Ensure you have the latest version of the package. Visit [Nuget](https://www.nuget.org/packages/AfricasTalking.NET/) for more info on the latest release of this package
