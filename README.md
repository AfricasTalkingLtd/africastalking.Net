...
+ Key in **AfricasTalking.NET** and select version _1.1.602_ or higher. 
...
```powershell 
 dotnet add package AfricasTalking.NET --version 1.1.602
```
...
```powershell 
Install-Package AfricasTalking.NET -Version 1.1.602 
```
> Ensure you have the latest version of the package. Visit [Nuget](https://www.nuget.org/packages/AfricasTalking.NET/) for more info on the latest release of this package
